...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog, screenDim):
        ...
        self.verticalLayout1.addWidget(self.checkBox_summary)

        self.checkBox_RawData = QtWidgets.QCheckBox(Dialog)
        self.checkBox_RawData.setObjectName("checkBox_RawData")
        self.verticalLayout1.addWidget(self.checkBox_RawData)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.verticalLayout1.addItem(spacerItem)
        self.gridLayout.addLayout(self.verticalLayout1, 1, 2, 2, 1)
        ...
        self.gridLayout.addLayout(self.verticalLayout, 1, 0, 4, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_RawData.setText(_translate("Dialog", "Raw Data (.csv)"))
