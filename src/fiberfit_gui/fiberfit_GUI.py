...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, heigth, width):
        ...
        # 0.4 and 0.1 were the numbers that I picked based on how it looked.
        MainWindow.resize(0.4*int(width.__str__()), 0.1*int(heigth.__str__()))
        ...
        self.selectImgBox.setMaximumSize(QtCore.QSize(170, 20))
        ...
        self.nextButton.setMinimumSize(QtCore.QSize(95, 50))
        self.nextButton.setMaximumSize(QtCore.QSize(95, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.prevButton.setMinimumSize(QtCore.QSize(95, 50))
        self.prevButton.setMaximumSize(QtCore.QSize(95, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
